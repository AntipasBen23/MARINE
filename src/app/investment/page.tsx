...
export default function InvestmentPage() {
  return (
    <main className="min-h-screen">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm border-2" style={{ borderColor: '#d4a029' }}>
              <h3 className="text-2xl font-bold mb-4" style={{ color: '#1a4d2e' }}>
                Kogi State Gold Project
              </h3>
              <div className="space-y-3 mb-6">
                <p style={{ color: '#2d5a3d' }}>
                  <strong style={{ color: '#1a4d2e' }}>Cadastral Units:</strong> 410 CUs
                </p>
                <p style={{ color: '#2d5a3d' }}>
                  <strong style={{ color: '#1a4d2e' }}>Focus:</strong> Gold Exploration & Mining
                </p>
                <p style={{ color: '#2d5a3d' }}>
                  <strong style={{ color: '#1a4d2e' }}>Location:</strong> Lokoja, Kogi State
                </p>
              </div>
              <a 
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border-2" style={{ borderColor: '#d4a029' }}>
              ...
              <div className="space-y-3 mb-6">
                <p style={{ color: '#2d5a3d' }}>
                  <strong style={{ color: '#1a4d2e' }}>Cadastral Units:</strong> 380 CUs Available
                </p>
                <p style={{ color: '#2d5a3d' }}>
                  <strong style={{ color: '#1a4d2e' }}>Minerals:</strong> 64+ Identified
                </p>
                <p style={{ color: '#2d5a3d' }}>
                  <strong style={{ color: '#1a4d2e' }}>Location:</strong> Calabar, Cross River State
                </p>
              </div>
              <a 
      ...
      {/* CTA */}
      <section className="py-16 text-white" style={{ background: 'linear-gradient(to right, #1a4d2e, #2d5a3d)' }}>
